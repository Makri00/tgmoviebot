...
* `SINGLE_BUTTON`: choose b/w [single or double buttons](https://github.com/Makri00/tgmoviebot/issues/1) True/False.
...
<p>
<br>
<a href="https://heroku.com/deploy?template=https://github.com/Makri00/tgmoviebot/tree/master">
